...
// ACSPinKit
#define COCOAPODS_POD_AVAILABLE_ACSPinKit
#define COCOAPODS_VERSION_MAJOR_ACSPinKit 0
#define COCOAPODS_VERSION_MINOR_ACSPinKit 1
#define COCOAPODS_VERSION_PATCH_ACSPinKit 1
